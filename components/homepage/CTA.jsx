          ...
          <div className="space-y-6 pt-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="space-y-0.5 text-sm">
                ...
                <a href="mailto:soluvent***@gmail.com" className="font-semibold text-[#0f172a] hover:underline">
                  soluvent***@gmail.com
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="space-y-0.5 text-sm">
                ...
                <a href="tel:+1234567890" className="font-semibold text-[#0f172a] hover:underline">
                  +123 - 456 - 7890
                </a>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                >
                  ...
                  <option value="agriculture">Agriculture & Petrochemicals</option>
                  <option value="research">Laboratory & Research</option>
                </select>
              </div>
